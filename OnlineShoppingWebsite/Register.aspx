...
<body>
       ...
       <div style=" height: 830px;">
            <table style="width: 700px; height: 702px; background-color:#800000; background-image: url('Images/bla.jpg'); color: #FFFFFF;" align="center">
                <%-- Register Logo Image--%>
                  <tr>
                  ...
                  <tr>
                   ...
                   <tr>
                          ...
                          <td style="vertical-align:top">
                               <asp:TextBox ID="TextBox3" runat="server" BackColor="white" Height="29px"
                    ...
                    <tr>
                          ...
                          <td style="vertical-align:top">
                               ...
                               <asp:RequiredFieldValidator ID="RequiredFieldValidatot3" runat="server"
                    ...
                    <tr>
                          ...
                          <td style="vertical-align:top">
                               <asp:TextBox ID="TextBox5" runat="server" BackColor="white" Height="32px"
                    ...
                    <%--Phone No. with Required Field & Regular Validation--%>
                    <tr>
                         <td align="center" style="width:50%">
                              <b>Phone_No:</b>
                         </td>
                         <td style="vertical-align:top">
                              <asp:TextBox ID="TextBox6" runat="server" BackColor="white" Height="29px"
                   ...
                   <tr>
                        <td align="center" style="width:50%">
                              <b>Password:</b>
                         <td style="vertical-align:top">
                              <asp:TextBox ID="TextBox7" runat="server" BackColor="white" Height="29px"
                   ...
                   <%--Confirm Passsword with Required Field & Compar Validation--%>
                   <tr> 
                          <td align="center" style="width:50%">
                               <b>Confirm Password:</b>
                          </td>
                          <td style="vertical-align:top">
                               <asp:TextBox ID="TextBox8" runat="server" BackColor="white" Height="29px"
                  ...
                  <tr>
                       <td colspan="2" align="center">
                            <asp:ImageButton ID="ImageButton1" runat="server" Height="102px"
                                   ImageUrl="~/Images/register2.png" Width="120px"
                                  onclick="ImageButton1_Click" TabIndex="8" style="margin-left: 0px" /><hr />
                      </td>
               </tr>
