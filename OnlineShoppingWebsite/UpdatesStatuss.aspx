...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div align="center" class="navbar" style="height: auto; color: #000000;">
             <%--Display List of Order--%>
             <div align="right">
                  <asp:LinkButton ID="AllOrder" runat="server" ForeColor="White"   OnClick="AllOrder_Click">Show All Order List</asp:LinkButton>
                  &nbsp;
             </div>
      ...
      <asp:Button ID="Button1" runat="server" Text="Click" OnClick="Button1_Click"
            ...
            <asp:GridView ID="GridView1" runat="server" BackColor="White"
             ...
             <asp:Button ID="Button2" runat="server" Text="Upate Status"
